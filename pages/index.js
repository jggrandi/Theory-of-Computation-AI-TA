...
export default function Home() {
  ...
  async function onSubmit(event) {
    ...
    console.log("On submit - messageType:", messageType, "isChallengeMode:", isChallengeMode);
                ...
                <div className={`container`}>
                  <form onSubmit={onSubmit} className={`d-flex`}>
                    <input
                      type="text"
                      name="question"
                      placeholder={isChallengeMode ? "Please answer the challenge question" : "Enter your question"}
                      value={questionInput}
